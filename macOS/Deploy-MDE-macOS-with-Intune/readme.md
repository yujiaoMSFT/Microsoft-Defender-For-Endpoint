...
| 4 | [Deploy Defender application](https://github.com/yujiaoMSFT/Microsoft-Defender-For-Endpoint/blob/main/macOS/Deploy-MDE-macOS-with-Intune/4_Deploy_Defender_App.md) | Use Custom Intune script to install Defender application to your macOS device group in Intune, then verify deployment status in the portal to ensure successful installation. |
