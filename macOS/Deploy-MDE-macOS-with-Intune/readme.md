...
| 3 | [Deploy MDE configuration settings (using Graph API)](macOS/Deploy-MDE-macOS-with-Intune/3_Deploy_MDE_Configuration_Files.md) | Use a PowerShell script with Graph API to automate deployment of MDE macOS configuration profiles in Intune, saving time over manual setup. |
